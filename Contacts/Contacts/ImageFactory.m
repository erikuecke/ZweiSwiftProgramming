...
//  Contacts
//
//  Created by Erik Uecke on 4/20/17.
...
+ (UIImage *)generateDefaultImageOfSize:(CGSize)size
{
    ...
    CGFloat seperation = frame.size.width * 0.1;
    
    CGPoint leftPt = CGPointMake(center.x - (seperation + eyeSize.width), center.y - (eyeSize.height * 2));
    CGPoint rightPt = CGPointMake(center.x + seperation, center.y - (eyeSize.height * 2));
